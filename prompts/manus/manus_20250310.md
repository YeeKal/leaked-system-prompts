...
- [Agent Loop](#agent-loop):Describes the iterative workflow of the Manus AI agent
- [Modules](#modules): Defines the system architecture and operational rules
- [Prompt](#prompt): Outlines user-facing capabilities and interaction guidelines
- [Tools](#tools): Catalog of executable functions with strict usage parameters
