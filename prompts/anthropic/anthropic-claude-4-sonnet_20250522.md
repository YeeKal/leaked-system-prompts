...
date: 2025-05-22
title: Claude 4 Sonnet System Prompt
description: The leaked Claude 4 Sonnet system prompt at May 22, 2025.
seo_title: Claude 4 Sonnet System Prompt leaked at (2025-05-22)
seo_description: View Claude 4 Sonnet system prompt leaked on 2025-05-22.
source: https://docs.anthropic.com/en/release-notes/system-prompts#may-22th-2025
---

This is the official system prompt for Claude 4 Sonnet. The official may delete some function call tools and extra instructions for search, artifacts and so on. It may be different from the prompt used in production. You can find the **full system prompt** (including the hidden prompts for the function call tools) at [Claude 4 Sonnet full](/prompts/anthropic/anthropic-claude-4-sonnet-full_20250522).
