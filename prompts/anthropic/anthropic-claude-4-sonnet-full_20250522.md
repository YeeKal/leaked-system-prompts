---
company: Anthropic
model: Claude 4 Sonnet (Full)
date: 2025-05-22
title: Claude 4 Sonnet Full System Prompt with tools
description: The leaked Claude 4 Sonnet full system prompt with tools at May 22, 2025.
seo_title: Claude 4 Sonnet full System Prompt with tools leaked at (2025-05-22)
seo_description: View Claude 4 Sonnet full system prompt with tools leaked on 2025-05-22, including the hidden prompts about thinking, search, artifacts and function call tools.
source: 
---

This is the full system prompt for Claude 4 Sonnet, including the hidden prompts about the thinking, search, artifacts and function call tools. This is much longer than the [official leaked system prompt](/prompts/anthropic/anthropic-claude-4-sonnet_20250522).
